...
import { GraduationCap, BookOpen, AlertCircle, Smartphone, Mail, Lock, User, Phone } from "lucide-react";
              ...
              <div className="mb-6">
                ...
                <RadioGroup value={loginMode} onValueChange={(v) => {
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className={`relative flex items-center space-x-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                      loginMode === "student" ? "border-indigo-600 bg-indigo-50" : "border-gray-200 hover:border-indigo-300"
                    }`}>
                    ...
                    <div className={`relative flex items-center space-x-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                      loginMode === "teacher" ? "border-purple-600 bg-purple-50" : "border-gray-200 hover:border-purple-300"
                    }`}>
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup value={role} onValueChange={(v) => {
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className={`flex items-center space-x-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                        role === "teacher" ? "border-purple-600 bg-purple-50" : "border-gray-200 hover:border-purple-300"
                      }`}>
